...
En esta actividad los estudiantes aprenden conceptos introductorios relacionados con la lógica computacional. Desarrolle las siguientes tareas:

## TAREA 01: Sistema computacional

1. Lea el siguiente texto:

:::{admonition} ¿Qué es un sistema computacional?
:class: tip
...
2. Acorde al texto anterior: **¿Qué es un sistema computacional?**, en su cuaderno responda las siguientes preguntas:
...
3. En su cuaderno, Indique 5 ejemplos de sistemas computacionales.

    - EJEMPLO: Un *portátil* es un ejemplo de **sistema computacional** porque su *hardware* y *software* permite registrar, almacenar y mostrar información para un usuario”.
...
2. Acorde al texto: **¿Qué es informática?**, responda las siguientes preguntas en su cuaderno:
...
:align: center
:width: 300
Los bancos deben garantizar integridad y disponibilidad
```
